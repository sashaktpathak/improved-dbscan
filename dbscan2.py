...
FILENAME = 'datasets/clusters5.csv'
DELIM = ';'
...
def DBSCAN(eps, eps_ , minPts):
    ...
    result_silhouette = validations2.Silhouette(clusters, distanceMatrix);
    ...
    validations2.SumOfSquares(clusters, centroids, 'E')
    validations2.DunnIndex(clusters, centroids, 'E')
    validations2.printSizeOfClusters(clusters);
    return clusters
